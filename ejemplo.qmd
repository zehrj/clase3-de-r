...
```{r}
save(data, file="input/data/procesados/data.rdata")
```
...
esta es una tabla descriptiva. Como muestra la @tbl-sjmisc, resultados dicen que 
...
La @fig-gdp entrega el pib de manera ordenada
